...
Here are also some corollaries of Pontryagin's Maximum Principle that may useful from textbook \[8\]: 
...
## Summary
 - One of the most important reasona that make **PMP** crucial lies in the fact that maximizing the Hamiltonian is much easier than the original infinite-dimensional control problem. It converts the problem of maximizing over a function space to a pointwise optimization.
