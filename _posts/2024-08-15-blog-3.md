...
$$
\frac{\partial V(x,t_{\infty})}{\partial t} + \min_u \left[ \left(\frac{\partial V(x,t_{\infty})}{\partial x} \right)^T \cdot \dot{x} + \frac{1}{2} x^T Q x + \frac{1}{2} u^T R u \right] = 0
$$
...
$$
\min_u \left[ \left(\frac{\partial V(x,t_{\infty})}{\partial x} \right)^T \cdot (A x + B u) + \frac{1}{2}x^T Q x + \frac{1}{2}u^T R u \right] = 0
$$
...
$$ \min_u \left[ x^T P (A x + B u) + \frac{1}{2} x^T Q x + \frac{1}{2} u^T R u \right] = 0 $$
...
$$ \frac{\partial}{\partial u} \left( x^T P B u + \frac{1}{2}u^T R u \right) = 0 $$
...
$$
x^T P A x + x^T P B \left(-R^{-1} B^T P x \right) + x^T Q x + \left(-R^{-1} B^T P x \right)^T R \left(-R^{-1} B^T P x \right) = 0
$$
