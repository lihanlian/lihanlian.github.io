...
with torch.no_grad():
            ...
            best_idx = torch.argmax(q_table_next, dim=1)
            q_val_next = q_table_next[torch.arange(q_table_next.size(0)),best_idx]
...
## References
 ...
 5. <i class="fa-brands fa-github"></i> [minimal-isaac-gym](https://github.com/lorenmt/minimal-isaac-gym), <i class="fa-brands fa-github"></i> [DPG-Pytorch](https://github.com/XinJingHao/DDPG-Pytorch), <i class="fab fa-youtube"></i>[cartpole-dqn-ddpg-ppo](https://github.com/lihanlian/cartpole-dqn-ddpg-ppo)
